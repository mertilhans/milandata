...
/*   Updated: 2025/08/18 16:14:32 by merilhan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		t_env *env_list)
{
	...
	if (current_redir->no_expand)
		data->heredoc_content = read_single_block(current_redir->filename);
	else
		data->heredoc_content = read_heredoc_expand(current_redir->filename,
				env_list);
