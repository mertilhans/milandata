...
/*   Updated: 2025/08/19 12:59:13 by husarpka         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int							process_read_char(ssize_t bytes, char ch,
								t_heredoc_state *st);
...
int							heredoc_fd_error(t_parser *cmd_list,
								t_exec_data *data, t_parser *current_cmd);
